...
wget https://github.com/vinceliuice/Qogir-theme/archive/refs/tags/2021-04-20.zip -O Qogir-theme.zip; 
7za x Qogir-theme.zip; 
cd Qogir-theme-2021-04-20; 
./install.sh; 
cd ..;
rm -Rf Qogir-theme.zip 2>/dev/null; 
rm -Rf Qogir-theme-2021-04-20/ 2>/dev/null; 
