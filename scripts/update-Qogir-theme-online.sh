...
wget https://github.com/vinceliuice/Qogir-theme/archive/2020-02-26.zip -O Qogir-theme.zip; 
7za x Qogir-theme.zip; 
cd Qogir-theme-2020-02-26; 
./install.sh; 
cd ..;
rm -Rf Qogir-theme.zip 2>/dev/null; 
rm -Rf Qogir-theme-2020-02-26/ 2>/dev/null; 
