...
wget https://github.com/vinceliuice/Qogir-icon-theme/archive/2020-11-22.zip -O Qogir-icon-theme.zip; 
7za x Qogir-icon-theme.zip; 
cd Qogir-icon-theme-2020-11-22; 
./install.sh; 
cd ..;
rm -Rf Qogir-icon-theme.zip 2>/dev/null; 
rm -Rf Qogir-icon-theme-2020-11-22/ 2>/dev/null; 
