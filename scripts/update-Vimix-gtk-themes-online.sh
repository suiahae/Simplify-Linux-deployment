...
wget https://github.com/vinceliuice/vimix-gtk-themes/archive/2020-11-28.zip -O vimix-gtk-themes.zip; 
7za x vimix-gtk-themes.zip; 
cd vimix-gtk-themes-2020-11-28; 
./install.sh; 
cd ..;
rm -Rf vimix-gtk-themes.zip 2>/dev/null; 
rm -Rf vimix-gtk-themes-2020-11-28/ 2>/dev/null; 
