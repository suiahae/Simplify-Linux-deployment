...
wget https://github.com/vinceliuice/vimix-gtk-themes/archive/refs/tags/2021-04-25.zip -O vimix-gtk-themes.zip; 
7za x vimix-gtk-themes.zip; 
cd vimix-gtk-themes-2021-04-25; 
./install.sh; 
cd ..;
rm -Rf vimix-gtk-themes.zip 2>/dev/null; 
rm -Rf vimix-gtk-themes-2021-04-25/ 2>/dev/null; 
